...
import { Button } from "@mui/material";
import NextPage from "../nexpage/NextPage.jsx";
import "./properties/Amenities.css";
...
function Amenities() {
  ...
  const additionalAmenitiesChange = (e) => {
  ...
  return (
    <div className="amenities-container">
      ...
      <p className="description">Provide details to increase visibility of your listing</p>
      ...
      <div className="grid-2">
        ...
        <div className="form-group full-width">
          ...
          <input
            ...
            value={amenities.secondary_number}
            onChange={amenitiesChange}
        ...
        <div className="form-group full-width">
          <label>Direction tips for tenants*</label>
          <textarea
            name="directions"
            value={amenities.directions}
            onChange={amenitiesChange}
            placeholder="Eg. Take the road opposite to..."
          />
        </div>
      </div>
      ...
      <div className="radio-group">
        {[
          ["gym", "Gym"],
          ["non_veg", "Non-Veg Allowed"],
          ["security", "Gated Security"],
        ].map(([key, label]) => (
          <div key={key} className="radio-row">
            <span>{label}*</span>
            <label><input type="radio" name={key} value="true" checked={amenities[key] === true} onChange={amenitiesChange} /> Yes</label>
            <label><input type="radio" name={key} value="false" checked={amenities[key] === false} onChange={amenitiesChange} /> No</label>
          </div>
        ))}
      </div>
      ...
      <div className="checkbox-section">
        ...
        <div className="checkbox-grid">
          {Object.entries(amenities.additional_amenities).map(([key, checked]) => (
            <label key={key} className="checkbox-item">
              <input
                type="checkbox"
                name={key}
                checked={checked}
                onChange={additionalAmenitiesChange}
              />
      ...
      <div className="action">
        {!amenities.secondary_number ? (
          <Button variant="contained" onClick={() => alert("Enter secondary number")}>Save & Next</Button>
        ) : (
          <NextPage details={amenities} />
        )}
      </div>
    </div>
  );
